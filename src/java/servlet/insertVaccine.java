 ...
 * @author poramet
 */
public class insertVaccine extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        model.StudentTable.insertStudent(stuObj);
        request.getRequestDispatcher("chooseVaccinejsp.jsp").forward(request, response);
    }
